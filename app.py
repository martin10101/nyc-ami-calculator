...
class TrulyCompleteAMIOptimizationSystem:
    ...
    def __init__(self):
        ...
        self.AMI_STRATEGIES = {
            'closest_to_60': {'40': 0.20, '60': 0.70, '80': 0.10, '100': 0.00},  # 20% at 40% AMI, 58.0% weighted avg
            'floor_optimized': {'40': 0.22, '60': 0.68, '80': 0.10, '100': 0.00},  # 22% at 40% AMI, 58.4% weighted avg  
            'size_optimized': {'40': 0.25, '60': 0.65, '80': 0.10, '100': 0.00},  # 25% at 40% AMI, 58.5% weighted avg
        }
